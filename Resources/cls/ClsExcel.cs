...
namespace ManageMaterialPBA
{
    class ClsExcel
    {
        ...
        public bool exportLogfileKP(DataGridView dtg1, string path, bool check, int c1, int c2)
        {
            try
            {
                StringBuilder sb = new StringBuilder();
        ...
        //Tạo folder lưu trữ
        public void createFoler(string daTim, string name)
        {
            string dirpath = @Application.StartupPath + "\\History\\WH\\" + name + "\\" + daTim;
        ...
        public bool checkExitPO(string daTim, string name)
        {
            string dirpath = @Application.StartupPath + "\\History\\WH\\" + name + "\\" + daTim;
