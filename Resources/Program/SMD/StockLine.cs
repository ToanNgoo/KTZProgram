    ...
    public partial class StockLine : Form
    {
        ...
        private void btn_svStkLine_Click(object sender, EventArgs e)
        {
            ...
            if(fil_name != "")
            {
                ...
                bool chek2 = excl.checkExitLog(@Application.StartupPath + "\\tem\\" + dtim + "_StockLine.csv");
                excl.exportStockKTZZ(dgv_stockLine, @Application.StartupPath + "\\tem\\" + dtim + "_StockLine.csv", chek2);
        ...
        private void dgv_stockLine_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {                
                ...
                //StreamReader sr = new StreamReader(@Application.StartupPath + "\\Log\\Duplicate\\Old\\" + str[2] + str[0] + str[1] + "_NewCode.log");
                StreamReader sr = new StreamReader(@Application.StartupPath + "\\Log\\Duplicate\\Input_Line.log");
                FileStream fs = new FileStream(@Application.StartupPath + "\\Print\\Line\\" + str[2] + str[0] + str[1] + "_NewCode.log", FileMode.Create);
