...
namespace ManageMaterialPBA
{
    ...
    {
        public bool _adminn;
        public InformationPicture(bool adminn)
        {
            InitializeComponent();
            _adminn = adminn;
        }
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            if(_adminn == true)
            {
                ...
                if (fil_name != "")
                {
                    ...
                    if (File.Exists(@Application.StartupPath + "\\Picture\\" + str[str.Length - 1]))
                    {
                        ...
                        {
                            File.Delete(@Application.StartupPath + "\\Picture\\" + str[str.Length - 1]);
                            File.Copy(fil_name, @Application.StartupPath + "\\Picture\\" + str[str.Length - 1]);
                        }
                    }
                    else
                    {
